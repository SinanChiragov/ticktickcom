...
import calendars from '../../images/future/calendar1.png';
import './Calendar.css';
            ...
            <div className="calendarContainer">
                <div className="calendarContainer_sCnD">
                    <div className='calendarText'>
                        ...
                        <ul className='calendarVisibleList'>
                            <li className="show_1hE4Y">
                                ...
                                <div className="calendarItemText_2pQa8">
                                    <span className="calendarItemTitle_3HMwx">
                                        <font>
                                            <font>Various kinds of calendar</font>
                                        </font>
                                    </span>
                                    <span className="calendarItemDesc_1tMOE">
                                        <font>
                            ...
                            <li className="">
                                ...
                                <div className="calendarItemText_2pQa8">
                                    <span className="calendarItemTitle_3HMwx">
                                        <font>
                                            <font>Calendar Subscriptions</font>
                                        </font>
                                    </span>
                                    <span className="calendarItemDesc_1tMOE">
                                        <font>
                                            <font>Subscribe to other TickTick calendar apps to manage your events and tasks in one place</font>
                                        </font>
                                    </span>
                                    <span className="calendarItemInfo_2Qui2 calendarItemDesc_1tMOE">
                                        <font>
                                            <font>* The ability to use the calendar is only available for Premium accounts</font>
                                        </font>
                                    </span>
                                </div></li>
                        </ul>
                    ...
                    <div className='calendarImage'>
                        <img src={calendars} alt='calendar' />
                    </div>
                </div>
            </div>
        </div>
