...
import pomoimg from '../../images/future/pomo1.png';
import './Pomo.css';
    ...
    return (
        <div className="features_3XM1">
            <div className="pomoContainer">
                <div className="pomoContainer_sCnD">
                    <div className="pomoImage">
                        <img alt="pomo" src={pomoimg} />
                    </div>
                    <div className="pomoText">
                        <h1 className="pomoTitle">Find out what to do next</h1>
                        <ul>
                            <li className="activeClass">
                                ...
                                <div>
                                    <strong>Folders, lists, pomo, and important items</strong>
                                    <span>Keep your pomo organised at four different levela.</span>
                                </div>
                            </li>
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
                                ...
                                <div>
                                    <strong>Tags</strong>
                                    <span>Create and add tags to your pomo to manage them flexibly.</span>
                            ...
                            <li>
                                ...
                                <div>
                                    ...
                                    <span>
                                        Mark and sort pomo into four priority levels: high priority, medium priority, low priority, and no priority.
                                    </span>
                                </div>
                            </li>
                        </ul>
