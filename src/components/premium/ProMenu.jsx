        ...
        <div>
            <div className="navRow_236y3 container">
                <ul className="navbar_2uuBv">
                    ...
                    <li className="navItem_2K7pc"><a href="/download" className="">Applications</a></li>
                    <li className="navItem_2K7pc"><a href="/upgrade" className="active_1e1wk">Premium</a></li>
                    <li className="navItem_2K7pc"><a href="https://support.ticktick.com">Help Center</a></li>
